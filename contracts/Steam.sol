...
contract Steam is ERC20 {
    ...
    mapping(address => uint256) burnerTokensToMint;
    ...
    constructor(uint256 STEAM_maxTokens) public {
        ...
        _symbol = "STEAM";
        _decimals = 18;
        _maxSupply = STEAM_maxTokens.mul(1e18);  // allows to enter the supply in standard numbers
        ERC20._mint(_msgSender(), 1e18);    // mints 1 token
        _UPS =  _msgSender();
    }
